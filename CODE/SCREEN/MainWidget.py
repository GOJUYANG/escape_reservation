...
class MainWindow(QMainWindow, Ui_MainWindow, Ui_Login):
    def __init__(self):
        ...
        self.logo.setPixmap(QPixmap('../../IMG/logo_1.png'))
        self.frame_theme.hide()
        self.frame_reservation.hide()
        self.frame_folium.hide()
        self.frame_request.hide()
        # --- 함수 호출
        self.widget_clicked()
        self.inset_folium()
        self.insert_theme()
    ...
    def widget_clicked(self):
        self.widget_theme.mousePressEvent = lambda e, name='theme': self.move_stack(e, name)
        self.widget_reservation.mousePressEvent = lambda e, name='reservation': self.move_stack(e, name)
        self.widget_folium.mousePressEvent = lambda e, name='folium': self.move_stack(e, name)
        self.widget_request.mousePressEvent = lambda e, name='request': self.move_stack(e, name)
